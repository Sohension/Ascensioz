      ...
      <div className="flex min-h-screen items-center justify-center bg-slate-100 dark:bg-gray-900">
        <Card className="w-full max-w-md border-slate-300 shadow-lg">
          <CardContent className="py-12 text-center">
            <h2
              className={`${montserrat.className} text-3xl font-bold text-black`}
            >
              Course Not Found
            </h2>

            <p className={`${rajdhani.className} mt-3 text-lg text-slate-600`}>
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-100 via-slate-200 to-slate-300 dark:bg-gray-900 px-4 pb-10 pt-8 sm:px-6 sm:pt-10 md:px-8 lg:px-10 lg:pb-14">
      ...
      <div className="mx-auto mb-16 w-full max-w-7xl py-4 sm:mb-20 lg:mb-24">
        <Link
          href="/practice"
          className={`${rajdhani.className} inline-flex items-center text-lg font-semibold text-blue-600 transition hover:text-blue-700`}
        >
          ← Back to Practice
        </Link>

        <h1
          className={`${montserrat.className} mt-6 text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl`}
        >
          {course.name} <span className="text-blue-600">Challenges</span>
        </h1>

        <p
          className={`${rajdhani.className} mt-4 max-w-3xl text-base leading-7 text-slate-700 sm:text-lg md:text-xl`}
        >
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-md">
            ...
            <div
              className={`${rajdhani.className} mt-1 text-sm text-slate-600`}
            >
              Challenges
            </div>
          </div>
          ...
          <div className="hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-md sm:block">
            <div className="text-3xl font-bold text-blue-600">
              {course.name}
            </div>
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          >
            ...
            >
              <CardHeader>
                ...
                <CardTitle
                  className={`${montserrat.className} mt-5 text-2xl font-extrabold text-black transition duration-300 group-hover:text-blue-600 sm:text-3xl`}
                >
                  {index + 1}. {ch.title}
                </CardTitle>

                <CardDescription
                  className={`${rajdhani.className} mt-2 text-base leading-7 text-slate-600 sm:text-lg`}
                >
                  {ch.description}
                </CardDescription>
              </CardHeader>
        ...
        {challenges.length === 0 && (
          <Card className="col-span-full border border-slate-300 bg-linear-to-br from-white via-slate-50 to-slate-100 shadow-md">
            <CardContent className="flex flex-col items-center justify-center py-20 text-center">
              <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-blue-100 text-5xl">
                🚀
              </div>
              ...
              <p
                className={`${rajdhani.className} mt-4 max-w-lg text-lg text-slate-600`}
              >
